...
module "zero_trust_rule_group" {
  ...
  custom_rules = [
    ...
    # Allow legitimate HTTP traffic (with additional validation)
    {
    ...
    # Allow legitimate static resources
    {
    ...
    # Allow legitimate API endpoints with proper authentication
    {
      name        = "AllowAuthenticatedAPIAccess"
      priority    = 26
      action      = "allow"
      metric_name = "allow_authenticated_api"
      statement_config = {
        and_statement = {
          statements = [
            {
